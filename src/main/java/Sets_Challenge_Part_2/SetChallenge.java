...
public class SetChallenge {
    public static void main(String[] args) {
         ...
         * the solarSystem collection and in the sets of moons for the appropriate
         * planets.
         * 
         * 2. a.equals(b) must return the same result as b.equals(a) - equals is
         * symmetric.
         * 
